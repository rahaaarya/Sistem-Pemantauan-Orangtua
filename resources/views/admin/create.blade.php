            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.mahasiswa.create') }}">Mahasiswa</a></li>
                        ...
                        <form action="{{ route('admin.mahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="jurusan_id" name="jurusan_id"> <!-- Ubah name menjadi jurusan_id -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_telepon') is-invalid @enderror" id="no_telepon" name="no_telepon" placeholder="Masukkan No Telepon">
                                    @error('no_telepon')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
